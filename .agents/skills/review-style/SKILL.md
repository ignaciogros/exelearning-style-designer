...
4. Run `assets/a11y-probe.js` in the page, through whatever tool your harness gives you for
   evaluating JavaScript in a live tab (with Claude in Chrome, `javascript_tool`). It
   returns computed contrast failures
